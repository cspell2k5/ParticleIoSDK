...
#warning("otp parameter missing from call. Documentation is unclear of how to use it. Call Particle.")
    ...
    case createClient(appName: String, productIdorSlug: ProductID?, redirect_uri: URL? = nil, type: PCClient.ClientType, token: PCAccessToken)
