...
extension PCAPIUser {
        ...
        ///
        /// ````swift
        ///             PCAPIUser.createAn_API_User(type: .product(name: "super_product"),
        ...
        ///                            // put the new user to work
        ///                      } else if response.error {
        ///                            //something went wrong lets check the description
    ...
    static public func createAn_API_User(type: PCAPIUser.UserType, parameters: UserParameters, token: PCAccessToken) -> CurrentValueSubject<PCAPIUser.ServerResponse?, PCError> {
        ...
        ///
        /// ````swift
        ///             PCAPIUser.updateAn_API_User(type: .product(name: "super_cool_product@api.particle.io"),
        ///                                         parameters: .init(friendlyName: "cool_user_name",
        ///                                                           scopes: [.devices_diagnostics_get]),
        ///                                         token: PCAccessToken)
        ///
    ...
    static public func updateAn_API_User(type: PCAPIUser.UserType, parameters: UserParameters, token: PCAccessToken) -> CurrentValueSubject<PCAPIUser.ServerResponse?, PCError> {
        ...
        ///
        /// ````swift
        ///             PCAPIUser.list_API_Users(type: .organization(name: "shared_organization_name"),
        ///                                      token: PCAccessToken)
        ///
        ///                 .sink { completion in
        ///                      switch completion {
        ...
        ///                 } receiveValue: { response in
        ///                      if response?.ok {
        ///                            let user = response?.team.first?.username
        ///                            // find the user you were looking for...?
        ///                      } else {
    ...
    static public func list_API_Users(type: PCAPIUser.UserType, token: PCAccessToken) -> CurrentValueSubject<PCAPIUser.ListResponse?, PCError> {
        ...
        ///
        /// ````swift
        ///             PCAPIUser.deleteAn_API_User(type: .organization(name: "shared_organization"),
        ///                                         username: "poorly_named_user",
        ///                                         token: PCAccessToken)
        ///
        ///                 .sink { completion in
        ///                      switch completion {
